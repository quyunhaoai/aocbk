...
- (void)layoutSubviews
{
    ...
    self.bottomView.sd_layout.leftSpaceToView(self.contentView, 12).rightSpaceToView(self.contentView, 12).heightRatioToView(self.contentView, 1).topEqualToView(self.contentView);
    self.bottomView.backgroundColor = [UIColor colorWithRed:247/255.0 green:244/255.0 blue:241/255.0 alpha:1.0];
...
- (void)configureAppearance
{
    ...
    for (NSInteger i = 0; i < self.weekdayPointers.count; i++) {
        ...
        if (i == 0 || i == self.weekdayPointers.count - 1) {
