...
//        _playButton.imageView.contentMode = UIViewContentModeScaleToFill;
//        [_playButton setBackgroundImage:[AliyunUtil imageWithNameInBundle:@"avcPlayIcon"] forState:UIControlStateNormal];
...
- (void)layoutSubviews{
    ...
    self.playButton.frame = CGRectMake(16, 16 ,16.5, 16.5);
...
//    [self.playButton setBackgroundImage:[AliyunUtil imageWithNameInBundle:@"al_play_start1" skin:skin] forState:UIControlStateNormal];
//    [self.playButton setBackgroundImage:[AliyunUtil imageWithNameInBundle:@"al_play_stop1" skin:skin] forState:UIControlStateSelected];
    [self.playButton setBackgroundImage:IMAGE_NAME(@"al_play_start1") forState:UIControlStateNormal];
    [self.playButton setBackgroundImage:IMAGE_NAME(@"al_play_stop1") forState:UIControlStateSelected];
