...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.tableView = [[UITableView alloc]initWithFrame:CGRectInset(self.bounds, 12, 0) style:UITableViewStylePlain];
...
- (void)layoutSubviews {
    ...
    [self.tableView setCornerRadius:4 withShadow:YES withOpacity:0.6];
}
...
//        lineLayer.backgroundColor = self.tableView.separatorColor.CGColor;
        lineLayer.backgroundColor = COLOR_e5e5e5.CGColor;
